...
<body>
    <div class="register">
        <div class="container d-flex justify-content-center align-items-center mt-5">
            <form  method="POST" class="register-form text-center p-3" dir="rtl">
            ...
            <div class="input px-2 d-flex pt-5">
                <input type="text" name="user_name" class="form-control mx-2 my-2" placeholder="اسم الصالة" required>
                <input type="text" name="owner" class="form-control mx-2 my-2" placeholder="اسم المالك" required>
            </div>
...
<?php
    ...
    if (isset($_POST["save"])){
        ...
        $sql  = "INSERT INTO halls VALUES( Null, '$_POST[user_name]', '$_POST[owner]', '$_POST[email]', '$_POST[phone]', '$_POST[password]', '$_POST[price]', '$_POST[services]', '$_POST[location]', '$_POST[capacity]', '$_POST[bank_account]', '$_POST[account_name]', '$_POST[image]')";
