    ...
    <div class="login">
        <div class="container d-flex justify-content-center align-items-center mt-5">
            ...
            <p class="fs-5 fw-bold ">تسجيل دخول</p>
                <input type="email" name="email" class="form-control mx-2 mb-3 mt-5" placeholder="البريد الالكتروني">
                <input type="password" name="password" class="form-control mx-2" placeholder="كلمة السر" >
            <input type="submit" value="دخول" name="save" class="btn back-color text-light mt-3 mb-2 px-4 fw-bold rounded-0" data-bs-target="#login" data-bs-toggle="modal">
...
<?php
    ...
    if(isset($_POST["save"])){
        ...
        $result = $connect->query("SELECT id FROM admin WHERE email ='$_POST[email]' AND password ='$_POST[password]'");
        ...
        if($result->num_rows == 0 ){
            ...
            header('Location:http://localhost:8080/hallsreservation/html/superadmin/html/pages/home.php');
        }
    }
?>